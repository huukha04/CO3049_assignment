...
async function submitProductForm() {
    ...
    try {
        const response = await fetch('http://localhost/PHP_MVC/public/admin/insertProduct', {
            method: 'POST',
            body: formData
        });
...
async function loadProduct() {
    try {
        const cinemaId = document.getElementById("cinemaSelect").value;
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/getProduct?cinema_id=${cinemaId}`);
...
async function editProduct(id) {
    try {
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/getProduct?id=${id}`);
...
async function deleteProduct(id) {
    ...
    try {
        ...
        const response = await fetch('http://localhost/PHP_MVC/public/admin/deleteProduct', {
...
async function loadInfoCinema() {
    ...
    try {
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/getCinema?id=${cinemaId}`);
        const res = await response.json();
...
async function loadSelectCinema() {
    try {
        const response = await fetch("http://localhost/PHP_MVC/public/admin/getCinema");
        const data = await response.json();
...
async function loadSelectRoom() {
    try {
        ...
        if (!cinemaId) return;
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/getRoom?cinema_id=${cinemaId}`);
        const data = await response.json();
        console.log(data);
...
async function loadSeat() {
    try {
        ...
        if (!roomId) return;
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/getSeat?room_id=${roomId}`);
        const data = await response.json();
        if (data.status) {
            const seat = document.getElementById("seat");
            seat.innerHTML = "";
...
async function insertSeat() {
    ...
    const formData = new FormData(form);
    const response = await fetch("http://localhost/PHP_MVC/public/admin/insertSeat", {
        method: "POST",
        body: formData
    });
    const data = await response.json();
...
function loadShowtime() {
    ...
    fetch(`http://localhost/PHP_MVC/public/admin/getShowtime?room_id=${roomId}&date=${date}`)
...
async function loadMovies() {
    try {
        ...
        const response = await fetch("http://localhost/PHP_MVC/public/admin/getMedia?type=movie");
        const data = await response.json();
        if (data.status) {
...
async function deleteShowtime(id) {
    try {
        ...
        const response = await fetch(`http://localhost/PHP_MVC/public/admin/deleteShowtime`, {
            method: "POST",
            body: dataForm,
        });
        const data = await response.json();
...
async function getShowtimeCSV() {
    ...
    const url = `http://localhost/PHP_MVC/public/admin/getShowtimeCSV?&room_id=${roomId}&date=${date}`;
...
async function insertShowtime() {
    try {
        ...
        const response = await fetch("http://localhost/PHP_MVC/public/admin/insertShowtime", {
            method: "POST",
            body: dataForm,
        });
        const data = await response.json();
...
async function submitCinemaInfo() {
    ...
    try {
        const response = await fetch('http://localhost/PHP_MVC/public/admin/updateCinema', {
            method: 'POST',
            body: formData,
        });
